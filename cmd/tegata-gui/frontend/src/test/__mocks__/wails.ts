...
export const App = {
  ...
  RecordHOTPUsed: vi.fn().mockResolvedValue(undefined),
  RecordTOTPUsed: vi.fn().mockResolvedValue(undefined),
  GetStaticPassword: vi.fn().mockResolvedValue(undefined),
  SignChallenge: vi.fn().mockResolvedValue("abcdef0123456789"),
  RecordChallengeResponseUsed: vi.fn().mockResolvedValue(undefined),
