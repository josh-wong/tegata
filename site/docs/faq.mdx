...
If you have lost both your passphrase and your recovery key, the vault cannot be recovered.
...
This section covers questions about adding, editing, and removing credentials, TOTP timers, auto-lock behavior, and tips for daily use.
