...
- **No vault path needed.** If you set `TEGATA_VAULT`, the TUI finds the vault automatically. Otherwise, run `tegata ui --vault /path/to/vault`, replacing `/path/to/vault` with the actual path to your vault.
