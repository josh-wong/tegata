...
Follow the instructions for your operating system to set up your platform for Tegata. If you use multiple operating systems, follow the instructions for each one.
...
<h3>Install desktop GUI dependencies</h3>
