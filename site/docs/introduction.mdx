...
Credentials are stored in a vault file on the USB drive, encrypted with AES-256-GCM using a passphrase you choose. All authentication happens locally—nothing is transmitted to a cloud service.
...
To set up a vault and generate your first TOTP code, see [Getting started](getting-started.mdx).
