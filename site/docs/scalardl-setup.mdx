...
The desktop GUI includes a setup wizard for the audit layer. After initializing your vault, your first vault unlock prompts you to enable audit logging. Follow the prompts to complete setup with no command-line interaction.
...
Running the commands in this section modifies the audit log irreversibly. Do not run these commands on a vault you use for real authentication. Use a test vault or back up your vault file before proceeding.
