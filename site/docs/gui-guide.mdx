...
The settings panel also includes a **Support the project** section with links to [GitHub Sponsors](https://github.com/sponsors/josh-wong), [Ko-fi](https://ko-fi.com/josh_haha), and [PayPal](https://www.paypal.me/joshww) if you want to support the continued development of Tegata.

:::note[Support banner]

After every 10 vault unlocks, a support banner appears at the bottom of the main window. It includes the same links as the **Support the project** section in Settings.

Select **X** to dismiss the banner for the current session. Select **Don't show again** to permanently dismiss it. You can also use the support links in Settings at any time without waiting for the banner to appear.
