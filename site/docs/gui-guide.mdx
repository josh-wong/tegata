...
To switch to a different vault, select the **Switch vault** icon in the header toolbar. This locks the current vault and returns you to the vault selection screen.
