---
title: Set up your OS
sidebar_position: 2
description: Windows, macOS, and Linux setup instructions for Tegata, including USB formatting, permissions, and OS quirks.
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

Tegata runs on Windows 10+, macOS 12+, and Linux (amd64). The CLI and TUI are self-contained, while the desktop GUI relies on each platform's system WebView. This page covers operating-system-specific configuration that goes beyond the [Quickstart](quickstart.mdx) guide—USB drive formatting, permission issues, auto-start behavior, and known OS quirks.
...
Windows users need to configure the USB drive format, handle PowerShell execution policies, and manage Microsoft Defender SmartScreen prompts that may block the Tegata binary.

<h3>Format your USB drive or microSD card</h3>
...
<h3>Allow the app through Microsoft Defender SmartScreen</h3>
...
<h3>Adjust the execution policy</h3>
...
<h3>Docker for audit logging</h3>
...
<h3>Set up the clipboard behavior on WSL2</h3>
...
<h3>Clear the quarantine flag</h3>
...
<h3>Set TEGATA_VAULT persistently</h3>
...
<h3>Mount your USB drive or microSD card</h3>
...
<h3>Install clipboard dependencies</h3>
...
<h3>Disable clipboard copy on headless servers and SSH sessions</h3>
...
<h3>Install desktop GUI runtime dependencies</h3>

The desktop GUI uses a system WebView. Install your distribution's WebView runtime library before running the GUI.

<Tabs groupId="linux-distro" queryString>
  <TabItem value="ubuntu-debian" label="Ubuntu / Debian (newer releases)">
...
```
  ...
  <TabItem value="ubuntu-older" label="Ubuntu / Debian (older releases)">
...
<h3>Install desktop GUI build dependencies (developer only)</h3>

If you are building the GUI from source, install development headers in addition to the runtime packages listed above.
...
<h3>Add user to Docker group for audit logging</h3>
