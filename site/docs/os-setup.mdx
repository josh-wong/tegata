...
Tegata runs on Windows 10+, macOS 12+, and Linux (amd64) without any runtime dependencies. This page covers operating-system-specific configuration that goes beyond the [Quickstart](quickstart.mdx) guide—USB drive formatting, permission issues, auto-start behavior, and known OS quirks.
